...
- Really thorough output:
  ![screenshot showing image from Cursor chat UI. Outlines that the code is correct and produces consistent results. Rendered a table of created solutions, and a high level summary of the algorithm used. Also outlines handled edge cases.](image.png)
